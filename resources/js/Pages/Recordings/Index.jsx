...
export default function Index({ recordings }) {
  ...
  return (
    <HomeLayout activeBar={"recordings"}>
      <Head title="Danh sách bản ghi" />

      <div className="p-6 xl:min-h-screen">
        {recordings.data.map((recording) => (
          <div className="px-1.5 md:px-0 md:max-w-[775px] mx-auto w-full" key={recording.id}>
              ...
              <div className="min-w-[72px]">
                <div className="sticky-reaction-bar items-center md:!mt-1 mt-3 gap-x-3 flex md:!flex-col flex-row md:ml-[-20px] text-[13px] font-semibold text-gray-400">
                  ...
                  <div className="flex-1 flex md:hidden flex-row-reverse items-center text-gray-500">
                    <span>{recording.view_count}</span>
                    <EyeOutline
                      height="20px"
                      width="20px"
                      color={"#9ca3af"}
                    ...
                    <span className="flex flex-row-reverse items-center">
                      <span>{recording.reply_count}</span>
                      <ChatboxOutline
                        height="20px"
                        width="20px"
                        color={"#9ca3af"}
              ...
              <div className="flex-1 overflow-hidden break-words">
                ...
                <div
                  ...
                  dangerouslySetInnerHTML={{
                    __html: recording.content,
                  }}
                />
                {recording.image_urls && recording.image_urls.length != 0 && (
                  <div className="square-wrapper mt-3 rounded overflow-hidden">
                    <ReactPhotoCollage {...getCollageSetting(recording.image_urls)} />
                  </div>
                )}
                ...
                <div className="flex-row flex-wrap flex text-[13px] items-center">
                  ...
                  >
                    ...
                    {(recording.author.verified || recording.author?.profile?.verified) && (
                      <VerifiedBadge />
                    )}
                  </Link>
                  ...
                  <div className="flex-1 flex-row-reverse items-center text-gray-500 hidden md:flex">
                    <span>{recording.view_count || recording.views_count}</span>
                    <EyeOutline
                      height="20px"
                      width="20px"
                      color={"#9ca3af"}
                    ...
                    >
                      <span>{recording.reply_count || recording.comments_count}</span>
                      <ChatboxOutline
                        height="20px"
                        width="20px"
                        color={"#9ca3af"}
