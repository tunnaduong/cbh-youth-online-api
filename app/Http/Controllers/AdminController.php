...
class AdminController extends Controller
{
  ...
  {
    $validator = Validator::make($request->all(), [
      'username' => ['required', 'string', 'min:3', 'max:20', 'regex:/^[a-zA-Z0-9_-]+$/', 'unique:cyo_auth_accounts'],
  ...
  public function updateUser(Request $request, $id)
  {
    ...
    $validator = Validator::make($request->all(), [
      'username' => ['string', 'min:3', 'max:20', 'regex:/^[a-zA-Z0-9_-]+$/', 'unique:cyo_auth_accounts,username,' . $id],
