        ...
        if ($skipExisting) {
          $existingNotification = \App\Models\Notification::where('user_id', $user->id)
            ...
            ->first(function ($notification) {
              ...
              return isset($data['message']) && $data['message'] === 'Chào mừng bạn đến với Diễn đàn học sinh Chuyên Biên Hòa! Hãy cùng chia sẻ, học hỏi và kết nối với những người bạn tuyệt vời nơi đây.';
            });
